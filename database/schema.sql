...
) ENGINE=InnoDB AUTO_INCREMENT=4069 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `automation_runs` (
  ...
  `preview_payload` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`preview_payload`)),
  `generated_payload` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`generated_payload`)),
  `warning_payload` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`warning_payload`)),
  ...
  KEY `fk_automation_runs_user` (`generated_by`),
...
DROP TABLE IF EXISTS `clause_content_pool`;
CREATE TABLE `clause_content_pool` (
  ...
  `scope_keyword` varchar(180) DEFAULT NULL,
  ...
  `audit_stage` varchar(60) DEFAULT NULL,
  ...
  KEY `fk_clause_content_pool_standard` (`standard_id`),
  KEY `fk_clause_content_pool_clause` (`clause_library_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4031 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
