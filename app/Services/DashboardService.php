...
class DashboardService
{
    public function metrics(int $tenantId): array
    {
        ...
        return [
            'cards' => [
                ...
                'revenue' => $this->revenue($tenantId, null, null),
                'monthly_revenue' => $this->revenue($tenantId, $monthStart, $monthEnd),
            ],
    ...
    private function auditCalendar(int $tenantId, string $today, string $next90): array
    {
