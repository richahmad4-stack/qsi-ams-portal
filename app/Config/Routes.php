...
$routes->group('', ['filter' => 'auth'], static function (RouteCollection $routes): void {
    ...
    $routes->post('workflow/certification/(:num)/audit-events/(:num)/responses/(:num)/autosave', 'Workflow\WorkflowActionController::autosaveRequirementResponse/$1/$2/$3', ['filter' => 'permission:reports,edit']);
    $routes->post('workflow/certification/(:num)/audit-events/(:num)/responses/(:num)/confirm', 'Workflow\WorkflowActionController::confirmRequirementResponse/$1/$2/$3', ['filter' => 'permission:reports,edit']);
    ...
    $routes->post('workflow/certification/(:num)/decision/gm-approval', 'Workflow\WorkflowActionController::saveGmApproval/$1', ['filter' => 'permission:certification_decisions,edit']);
