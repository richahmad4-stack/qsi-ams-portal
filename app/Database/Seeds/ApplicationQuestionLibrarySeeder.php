...
class ApplicationQuestionLibrarySeeder extends Seeder
{
    ...
    private function commonQuestions(): array
    {
        ...
        return [
            ...
            $this->q('legal_statutory_requirements', 'Applicable Legal and Regulatory Requirement', 'textarea', $s, 'Certification Required'),
            ...
            $this->q('product_process_risks', 'Risks associated with products, processes or activities', 'textarea', ['HACCP', 'ISO 22000', 'ISO 22000:2018'], 'Certification Required'),
            $this->q('haccp_plans_processes', 'Number of HACCP Studies / Plans', 'number', ['HACCP', 'ISO 22000', 'ISO 22000:2018'], 'Certification Required'),
            $this->q('technical_issues', '1a. Analysis of technical issues arising from the scope', 'textarea', ['HACCP', 'ISO 22000', 'ISO 22000:2018'], 'Certification Required'),
            $this->q('safety_requirements', '1b. Safety condition requirements', 'textarea', ['HACCP', 'ISO 22000', 'ISO 22000:2018'], 'Certification Required'),
            $this->q('technological_regulatory_context', '1c. Technological and Regulatory Context', 'textarea', ['HACCP', 'ISO 22000', 'ISO 22000:2018'], 'Certification Required'),
