...
$nav = [
    'Core' => $visibleItems([
        ...
        ['label' => 'Cycle Builder', 'icon' => 'fa-wand-magic-sparkles', 'href' => site_url('automation/cycle-generator'), 'match' => 'automation/cycle-generator', 'show' => $hasAnyRole(['super_admin']) && can('automation', 'view')],
